...
function Draw_Origin() {
	...
	line_col[1] = DrawLine_col(svgContainer_origin, origin_X + 5, origin_Y - unit_y, origin_Y + unit_y);
	...
	Text[0] = DrawText(svgContainer_origin, "Rule27: 變化前", 30, 30);
}
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule27: 變化後", 30, 30);
	Text[1] = DrawText(svgContainer_result, "W", origin_X, origin_Y - unit_y*2 - 10);
	Text[2] = DrawText(svgContainer_result, "W", origin_X, origin_Y + unit_y*2 + 10);
}
...
function Draw_Animation() {
	...
	line_col[1] = DrawLine_col(svgContainer_anime, origin_X + 5, origin_Y - unit_y, origin_Y + unit_y);
	
	var jsonCircles = [{ "x": origin_X, "y": origin_Y - unit_y},
						{ "x": origin_X, "y": origin_Y + unit_y}];
	
	line_w = DrawDashline_S(svgContainer_anime, origin_X, origin_X, origin_Y - unit_y*2, origin_Y + unit_y*2).style("opacity", 0);;
	
	DrawCircle_F(svgContainer_anime, jsonCircles);
	
	Text[0] = DrawText(svgContainer_anime, "Rule27: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "W", origin_X, origin_Y - unit_y*2 - 10).style("opacity", 0);;
	Text[2] = DrawText(svgContainer_anime, "W", origin_X, origin_Y + unit_y*2 + 10).style("opacity", 0);;
