...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule18: 變化前", 30, 30);
}
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule18: 變化後", 30, 30);
	Text[1] = DrawText(svgContainer_result, "﹀", origin_X - 10, origin_Y + 10);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule18: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "﹀", origin_X - 10, origin_Y + 10).style("opacity", 0);	
