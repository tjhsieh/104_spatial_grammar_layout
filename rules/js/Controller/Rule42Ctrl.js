...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule42: 變化前", 30, 30);
	Text[1] = DrawText(svgContainer_origin, "dr", origin_X, origin_Y);
}
...
function Draw_Result() {
	...
	var jsonCircles = [{ "x": origin_X, "y": origin_Y - 5}];
	
	DrawCircle_F(svgContainer_result, jsonCircles);

	Text[0] = DrawText(svgContainer_result, "Rule42: 變化後", 30, 30);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule42: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "dr", origin_X, origin_Y);
