...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule16: 變化前", 30, 30);
}
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule16: 變化後", 30, 30);
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule16: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "﹀", origin_X - unit_x - 12, origin_Y).style("opacity", 0);
