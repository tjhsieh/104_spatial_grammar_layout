...
function Draw_Origin() {
	...
	line_row[1] = DrawLine_row(svgContainer_origin, origin_Y + unit_y + 10, origin_X - unit_x, origin_X + unit_x);
	line_col[0] = DrawLine_col(svgContainer_origin, origin_X - unit_x - 10, origin_Y - unit_y, origin_Y + unit_y);
	line_col[1] = DrawLine_col(svgContainer_origin, origin_X + unit_x + 10, origin_Y - unit_y, origin_Y + unit_y);								
	...
	Text[2] = DrawText(svgContainer_origin, "Rule1: 變化前", 30, 30);
}
...
function Draw_Result() {
	...
	line_row[0] = DrawLine_row(svgContainer_result, origin_Y - unit_y - 10, origin_X - unit_x*3, origin_X + unit_x*3);
	line_row[1] = DrawLine_row(svgContainer_result, origin_Y + unit_y + 10, origin_X - unit_x*3, origin_X + unit_x*3);
	line_col[0] = DrawLine_col(svgContainer_result, origin_X - unit_x*3 - 10, origin_Y - unit_y, origin_Y + unit_y);
	line_col[1] = DrawLine_col(svgContainer_result, origin_X + unit_x*3 + 10, origin_Y - unit_y, origin_Y + unit_y);
	
	Rect[0] = DrawRect(svgContainer_result, origin_X - unit_x*3, origin_Y - unit_y);
	...
	Rect[3] = DrawRect(svgContainer_result, origin_X - unit_x*3, origin_Y);
	Rect[4] = DrawRect(svgContainer_result, origin_X - unit_x, origin_Y);
	Rect[5] = DrawRect(svgContainer_result, origin_X + unit_x, origin_Y);
	...
	Text[2] = DrawText(svgContainer_result, "Rule1: 變化後", 30, 30);
}
...
function Draw_Animation() {
	...
	Text[2] = DrawText(svgContainer_anime, "Rule1: 動畫", 30, 30);
