...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule24: 變化前", 30, 30);
	Text[1] = DrawText(svgContainer_origin, "a", origin_X - unit_x, origin_Y + 20);
}
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule24: 變化後", 30, 30);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule24: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "a", origin_X - unit_x, origin_Y + 20);
