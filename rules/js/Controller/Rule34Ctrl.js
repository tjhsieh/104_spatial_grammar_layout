...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule34: 變化前", 30, 30);
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule34: 變化後", 30, 30);
	Text[1] = DrawText(svgContainer_result, "﹀", origin_X - 10, origin_Y + 5);
	Text[2] = DrawText(svgContainer_result, "d", origin_X - unit_x - 20, origin_Y + 20);
	Text[3] = DrawText(svgContainer_result, "d", origin_X + unit_x, origin_Y + 20);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule34: 動畫", 30, 30);
	...
	Text[4] = DrawText(svgContainer_anime, "d", origin_X - unit_x - 20, origin_Y + 20).style("opacity", 0);
	Text[5] = DrawText(svgContainer_anime, "d", origin_X + unit_x, origin_Y + 20).style("opacity", 0);
