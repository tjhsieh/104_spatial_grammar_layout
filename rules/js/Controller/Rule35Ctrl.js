...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule35: 變化前", 30, 30);
	Text[1] = DrawText(svgContainer_origin, "﹀", origin_X - 10, origin_Y + 5);
	Text[2] = DrawText(svgContainer_origin, "Wd", origin_X - unit_x*2 - 20, origin_Y);
	Text[3] = DrawText(svgContainer_origin, "Wd", origin_X + unit_x*2, origin_Y);
}
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule35: 變化後", 30, 30);
	Text[1] = DrawText(svgContainer_result, "﹀", origin_X - 10, origin_Y + 5);
	Text[2] = DrawText(svgContainer_result, "w", origin_X - unit_x*0.7, origin_Y + 20);
	Text[3] = DrawText(svgContainer_result, "w", origin_X + unit_x*0.4, origin_Y + 20);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule35: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "﹀", origin_X - 10, origin_Y + 5);
	Text[2] = DrawText(svgContainer_anime, "Wd", origin_X - unit_x*2 - 20, origin_Y);
	Text[3] = DrawText(svgContainer_anime, "Wd", origin_X + unit_x*2, origin_Y);
	Text[4] = DrawText(svgContainer_anime, "w", origin_X - unit_x*0.7, origin_Y + 20).style("opacity", 0);
	Text[5] = DrawText(svgContainer_anime, "w", origin_X + unit_x*0.4, origin_Y + 20).style("opacity", 0);
