...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule36: 變化前", 30, 30);
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule36: 變化後", 30, 30);
	Text[1] = DrawText(svgContainer_result, "﹀", origin_X - unit_x*0.5 - 10, origin_Y + 5);
	Text[1] = DrawText(svgContainer_result, "﹀", origin_X + unit_x*0.5 - 10, origin_Y + 5);
	Text[3] = DrawText(svgContainer_result, "w", origin_X - unit_x*2, origin_Y + 20);
	Text[4] = DrawText(svgContainer_result, "w", origin_X + unit_x*1.5, origin_Y + 20);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule36:動畫", 30, 30);
	...
	Text[4] = DrawText(svgContainer_anime, "w", origin_X - unit_x*2, origin_Y + 20).style("opacity", 0);
	Text[5] = DrawText(svgContainer_anime, "w", origin_X + unit_x*1.5, origin_Y + 20).style("opacity", 0);
