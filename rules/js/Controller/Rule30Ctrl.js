...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule30: 變化前", 30, 30);
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule30: 變化後", 30, 30);
	Text[1] = DrawText(svgContainer_result, "﹀", origin_X - 10, origin_Y + 5);
	Text[2] = DrawText(svgContainer_result, "w", origin_X - unit_x - 20, origin_Y + 25);
	Text[3] = DrawText(svgContainer_result, "w", origin_X + unit_x, origin_Y + 25);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule30: 動畫", 30, 30);
	...
	Text[4] = DrawText(svgContainer_anime, "w", origin_X - unit_x - 20, origin_Y + 25).style("opacity", 0);
	Text[5] = DrawText(svgContainer_anime, "w", origin_X + unit_x, origin_Y + 25).style("opacity", 0);
