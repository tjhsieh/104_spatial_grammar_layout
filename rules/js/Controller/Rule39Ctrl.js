...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule39: 變化前", 30, 30);
	Text[1] = DrawText(svgContainer_origin, "dc", origin_X, origin_Y);
}
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule39: 變化後", 30, 30);
}
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule39: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "dc", origin_X, origin_Y);
