...
function Draw_Origin() {
	...
	Text[0] = DrawText(svgContainer_origin, "Rule29: 變化前", 30, 30);
	Text[1] = DrawText(svgContainer_origin, "﹀", origin_X - 10, origin_Y + 5);
	Text[2] = DrawText(svgContainer_origin, "Wd", origin_X - unit_x*3, origin_Y);
...
function Draw_Result() {
	...
	Text[0] = DrawText(svgContainer_result, "Rule29: 變化後", 30, 30);
...
function Draw_Animation() {
	...
	Text[0] = DrawText(svgContainer_anime, "Rule29: 動畫", 30, 30);
	Text[1] = DrawText(svgContainer_anime, "﹀", origin_X - 10, origin_Y + 5);
	Text[2] = DrawText(svgContainer_anime, "Wd", origin_X - unit_x*3, origin_Y);
