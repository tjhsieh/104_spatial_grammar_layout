...
function Draw_Origin() {
	...
	line_col[2] = DrawLine_col(svgContainer_origin, origin_X + unit_x*2 + 10, origin_Y, origin_Y + unit_y*2);
	...
	Text[0] = DrawText(svgContainer_origin, "Rule5: 變化前", 30, 30);
}
...
function Draw_Result() {
	...
	line_col[1] = DrawLine_col(svgContainer_result, origin_X + unit_x*2 + 10, origin_Y - unit_y*2, origin_Y + unit_y*2);
	...
	Text[0] = DrawText(svgContainer_result, "Rule5: 變化後", 30, 30);
}
...
function Draw_Animation() {
	...
	line_col[2] = DrawLine_col(svgContainer_anime, origin_X + unit_x*2 + 10, origin_Y, origin_Y + unit_y*2);
	...
	Text[0] = DrawText(svgContainer_anime, "Rule5: 動畫", 30, 30);
